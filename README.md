...
| Slice 1b | Arch Linux ARM boots from the USB drive on NVIDIA's L4T kernel with no initramfs: GPU (`nvidia-smi`), Wi-Fi, fan control, hardware watchdog, efivarfs read-only | booted and checked, attended, 2026-09-25; cold-boot and dead-man tests pending |
